...
from clab_image import ImageStim # Our local hacked copy
...
class BufferImageStim(ImageStim):
    ...
    **Example**::
    ...
    def __init__(self, win, buffer='back', rect=(-1, 1, 1, -1),
                 ...
                 name=None, autoLog=None, shader_program=None):
        """
        :Parameters:
        ...
        super(BufferImageStim, self).__init__(
            ...
            size=size, interpolate=interpolate, name=name, autoLog=False, shader_program=shader_program)
